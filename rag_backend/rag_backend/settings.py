...
SECRET_KEY = 'django-insecure-c$wu5-kwyad%p#b_(-n%jy=fjfe_ki5s5vz!-((rem0%)l!%hu'
...
CORS_ALLOW_ALL_ORIGINS = True #If you want to allow all origins (not recommended for production)
